pcall(function()
    queue_on_teleport([[
        task.wait(5)
        loadstring(game:HttpGet("https://raw.githubusercontent.com/trezzywezzy/dri/refs/heads/main/loader3.lua"))()
    ]])
end)
...
------------------------------------------------
-- HARDCODED KEYS (must be before saved key check)
------------------------------------------------
local hardcodedKeys = {
	["trez67"] = true,
}
...
if savedKey and (validKeys[savedKey] or hardcodedKeys[savedKey]) then
	print("Auto-login with saved key:", savedKey)
